<?php
 ...
 ob_start();
    ...
    $head='<head>';
        ...
        $head.='<meta property="og:title" content="'.$post_infor->title.'">';
        $head.='<meta property="og:description" content="'.$post_infor->short_des.'">';
        $head.='<meta property="og:url" content="'.$current_url.'">';
        $head.='<meta property="og:site_name" content="'.$home_name.'">';
        $head.='<meta property="og:image" content="'.$post_infor->thumnail->url.'">';
        ...
        $head.='<link href="'.$home_url.'/wp-content/themes/shopseo/templates/src/style-detail.css" rel="stylesheet">';
