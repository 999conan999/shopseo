      ...
      //
        ...
        if (currentSlide.length > 0 ) {
            if(!currentSlide.hasClass("loaded")){
                ...
                currentSlide.html('<video playsinline type="video/mp4" controls class="videorv" width="100%" height="'+prevHeight+'" controlsList="nodownload" oncontextmenu="return false;"><source src="' + videoSrc + '" type="video/mp4" ></video>');
