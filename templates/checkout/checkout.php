<?php
    ...
    // }
        ...
        require_once(get_stylesheet_directory().'/templates/checkout/control.php');
        ...
        $head.='<title> Thanh toán | '.$home_name.'</title>';
        $head.='<meta name="description" content="Trang thanh toán">';
        $head.='<link rel="canonical" href="'.$home_url.'">';
        $head.='<meta property="og:locale" content="vi_VN">';
        $head.='<meta property="og:type" content="website">';
        $head.='<meta property="og:title" content=" Thanh toán | '.$home_name.'">';
        $head.='<meta property="og:description" content="Trang thanh toán">';
        ...
        $head.='<link href="'.$home_url.'/wp-content/themes/shopseo/templates/src/checkout.css" rel="stylesheet">';
        $head.=$common->gg_header;
        //
        $head.='</head>';
        echo $head;
            require_once(get_stylesheet_directory().'/templates/checkout/main.php');
        echo '</html>';
