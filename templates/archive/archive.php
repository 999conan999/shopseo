    ...
    $id=$obj->term_id;
     ...
     ob_start();
        ...
        $head='<head>';
            ...
            $head.='<meta name="description"'.$data->short_des.'">';
            ...
            $head.='<meta property="og:description"'.$data->short_des.'">';
            ...
            if($is_tiktok){
            $head.='<link href="'.$home_url.'/wp-content/themes/shopseo/templates/src/splide.min.css" rel="stylesheet">';
            }
