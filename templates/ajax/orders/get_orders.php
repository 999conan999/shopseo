...
function get_orders_shopseo(){// search phone or email ~~ '' => get all
     global $wpdb;
     $table_prefix=$wpdb->prefix .'shopseo_orders';
     $quantity=20;
     $offset=0;
     $sql = $wpdb->prepare( "SELECT id,name_buyer,phone,address_1,note,order_status,data_carts,date_create FROM $table_prefix ORDER BY id DESC LIMIT %d OFFSET %d ",$quantity,$offset);
