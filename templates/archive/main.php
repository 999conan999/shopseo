                        ...
                        <ul class="splide__list">
                            ...
                            <li class="splide__slide">
                                <div class="item-video">
                                    ...
                                    <video playsinline type="video/mp4" class="var-video cs-video" width="100%" <?php echo $i<2?'poster="'.$poster.'" '.'data-poster="'.$poster.'"':'data-poster="'.$poster.'"'; ?> <?php echo $i==0?'src="'.$video->url.'" '.'data-src="'.$video->url.'"':'data-src="'.$video->url.'"'; ?> onclick="fs_play_index(<?php echo $i; ?>)"></video>
